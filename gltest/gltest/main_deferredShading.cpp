...
auto BunnyDiffuse = glm::vec3(0.0, 0.5, 0.5);
auto BunnySpecular = glm::vec3(0.5, 0.5, 0.0);
...
auto BunnyDiffusePtr = glm::value_ptr(BunnyDiffuse);
auto BunnySpecularPtr = glm::value_ptr(BunnySpecular);
...
int main(int argc, char * argv[]) {
	...
	gbufferPass.MeshBindUniformMatrix4(&bunny, "ModelMatrix", &BunnyModelMatrixPtr);
	gbufferPass.MeshBindUniformMatrix4(&bunny, "NormalMatrix", &BunnyNormalMatrixPtr);
	gbufferPass.MeshBindUniformVec3(&bunny, "diffuse", &BunnyDiffusePtr);
	gbufferPass.MeshBindUniformVec3(&bunny, "specular", &BunnySpecularPtr);
	...
	Texture* texture = fbo.GetTexture(1);
